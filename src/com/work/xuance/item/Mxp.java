...
public class Mxp extends BaseItem {
	...
	public static View getView(Context context, ViewGroup parent) {
		...
		View convertView = flater.inflate(R.layout.item_mxp, null);
		convertView.setTag(new Mxp(convertView));
		return convertView;
	}

	public Mxp(View view) {
